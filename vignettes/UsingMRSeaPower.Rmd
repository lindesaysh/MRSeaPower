...
vignette: >
  %\VignetteIndexEntry{Software for analysing the Power to Detect Change}
...
```{r nysteddatplot, fig.cap='Figure showing the survey effort and proposed windfarm site for the Nysted Windfarm.', comment=FALSE, message=FALSE, fig.height=6, fig.width=8}
library(ggplot2)
ggplot() + 
