...
## ----nysteddatplot, fig.cap='Figure showing the survey effort and proposed windfarm site for the Nysted Windfarm.', comment=FALSE, message=FALSE, fig.height=6, fig.width=8----
library(ggplot2)
ggplot() + 
...
## ----corcheck, cache=TRUE, eval=TRUE, echo=TRUE-------------------------------
...
## ----corrgen, cache=TRUE, warning=FALSE, message=FALSE------------------------
newdat<-generateNoise(nsim, fitted(bestModel), family='poisson', d=d)
...
## ----nyimpoccorr, echo=TRUE, eval=TRUE, cache=TRUE, warning=FALSE, message=FALSE----
nsim=500
...
## ----aukcorr.re, echo=TRUE, eval=TRUE, cache=TRUE-----------------------------
nsim=500
