...
nsim=5
powerout<-powerSimOverallChange(newdat, fowsim_glm, empdistpower, nsim=nsim, powercoefid=length(coef(fowsim_glm)), predictionGrid=predictdata, g2k=g2k, splineParams=splineParams, sigdif=TRUE, n.boot=500, impact.loc=c(510700, 6555700))
```
...
lazyLoad(filebase = 'FoWPower_cache/html/empdistpower_65466e1af9ddc03a7bcafc02c436b281')
```
