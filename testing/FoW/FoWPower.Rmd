...
Now that we know we can generate data that represents the original fairly well, we now generate data for the power analysis with a change imposed of **10\%**; a 10\% decline in animal numbers post event.
...
```{r}
summary(powerout, truebeta=log(0.9))
```
