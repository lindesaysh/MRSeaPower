...
```{r rawplot}
require(fields)
quilt.plot(fat$x.pos, fat$y.pos, fat$response)
```
...
```{r}
par(mfrow=c(2,2))
quilt.plot(fat$x.pos, fat$y.pos, fat$response, main='Original Data')
quilt.plot(fat$x.pos, fat$y.pos, fitted(bestModel), main='Fitted Values')
quilt.plot(fat$x.pos, fat$y.pos, newdat[,1], main='Simulated Data A')
quilt.plot(fat$x.pos, fat$y.pos, newdat[,10], main='Simulated Data B')
```
