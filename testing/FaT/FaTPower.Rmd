...
```{r}
bestModel<-make.gamMRSea(salsa1dout$bestModel, panelid = fat$panel, splineParams = salsa1dout$splineParams, varshortnames = varlist, gamMRSea=TRUE)
...
lazyLoad(filebase = 'FaTPower_cache/html/poweroutfat_1755b15e504051ccedd3a72751fc7b52')
```
