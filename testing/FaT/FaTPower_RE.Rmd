...
impdata<-genRedistData(bestModel, data=fat, changecoef.link=log(0.75), panels='panel', imppoly=bnd.wf)
...
fatsim_glm<-update(bestModel, .~. + eventphase +  eventphase:LocalRadialFunction(radiusIndices, dists, radii, aR), data=impdata)
